...
variable "MyDomain" {
  description = "Public domain name for Ingress resources."
  type        = string
}

variable "enable_ng2_arm" {
  description = "Enable ARM/Graviton node group (myeks-ng-2)."
  type        = bool
  default     = false
}

variable "enable_ng3_spot" {
  description = "Enable Spot instances node group (myeks-ng-3)."
  type        = bool
  default     = false
}
