...
각 ENI는 Primary IP 1개와 여러 개의 Secondary IP를 가질 수 있습니다. VPC CNI는 이 Secondary IP 슬롯을 Pod IP 풀로 활용합니다.
...
이 한도가 노드당 실행 가능한 Pod 수의 상한을 결정합니다. 자세한 계산은 [Pod Capacity](./3_pod-capacity.md)에서 다룹니다.
