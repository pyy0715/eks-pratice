...
- [Background](0_background.md) — Bearer 토큰, JWT, OAuth 2.0 / OpenID Connect, K8s Webhook 확장 모델, AWS SigV4 선수 지식
- [Overview](1_overview.md) — Access Control 파이프라인과 네 가지 호출 시나리오
- [Operator Authentication](2_operator-auth.md) — kubectl 토큰의 실체와 EKS Authorizer
- [Kubernetes RBAC](3_rbac.md) — Pod이 K8s API를 호출할 때의 권한 모델
