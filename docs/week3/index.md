...
- [Node Autoscaling](3_node-autoscaling.md) — CPA, Cluster Autoscaler, Over-Provisioning
- [Karpenter](4_karpenter.md) — Just-in-time 노드 프로비저닝, Disruption, Consolidation, EKS Auto Mode
<!--- [Fargate](5_fargate.md) — Firecracker microVM 기반 서버리스 컴퓨팅, 제약사항, 로깅-->
- [Lab](6_lab.md) — 실습 환경 배포 및 스케일링 실습 가이드
